...
SECRET_KEY = 'django-insecure-orq7eyp67+!u1cfx64+_t73avh%-sw)(5nm5bmowk!py=paxj2'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Use BASE_DIR to specify the path to the SQLite file
    }
}
